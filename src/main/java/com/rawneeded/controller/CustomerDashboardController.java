...
public class CustomerDashboardController {
    ...
    private final ICustomerDashboardService customerDashboardService;

    @GetMapping("/stats")
    @Operation(
            summary = "Get customer dashboard statistics",
            description = "Get comprehensive dashboard statistics for customer based on ownerId from token"
    )
    public ResponseEntity<ResponsePayload> getDashboardStats() {
        DashboardStatsDto stats = customerDashboardService.getDashboardStats();
