...
public enum PlanFeatures {
    ...
    SUPPLIER_PRIVATE_ORDERS("Clients Special Orders", "طلبات العملاء الخاصة", PlanType.SUPPLIER),
    ...
    // Customer Features
    CUSTOMER_PRIVATE_ORDERS("Clients Special Orders", "طلبات العملاء الخاصة", PlanType.CUSTOMER),
